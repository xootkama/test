...
main:                                   // @main
.Lfunc_begin0:
	.file	1 "/workspace/template-python-flask/lal/out/../scripts/mod/devicetable-offsets.c"
	.loc	1 9 0                           // ../scripts/mod/devicetable-offsets.c:9:0
...
// %bb.0:
	...
	.cfi_offset w29, -16
.Ltmp0:
	.loc	1 9 0 prologue_end              // ../scripts/mod/devicetable-offsets.c:9:0
	bl	_mcount
.Ltmp1:
	.loc	1 10 2                          // ../scripts/mod/devicetable-offsets.c:10:2
	//APP
...
.ascii "->OFF_usb_device_id_bInterfaceNumber 16 offsetof(struct usb_device_id, bInterfaceNumber)"
	//NO_APP
	.loc	1 24 2                          // ../scripts/mod/devicetable-offsets.c:24:2
	//APP
...
.ascii "->OFF_hid_device_id_product 8 offsetof(struct hid_device_id, product)"
	//NO_APP
	.loc	1 30 2                          // ../scripts/mod/devicetable-offsets.c:30:2
	//APP
...
.ascii "->OFF_ieee1394_device_id_version 16 offsetof(struct ieee1394_device_id, version)"
	//NO_APP
	.loc	1 37 2                          // ../scripts/mod/devicetable-offsets.c:37:2
	//APP
...
.ascii "->OFF_pci_device_id_class_mask 20 offsetof(struct pci_device_id, class_mask)"
	//NO_APP
	.loc	1 45 2                          // ../scripts/mod/devicetable-offsets.c:45:2
	//APP
...
.ascii "->OFF_ccw_device_id_dev_model 7 offsetof(struct ccw_device_id, dev_model)"
	//NO_APP
	.loc	1 52 2                          // ../scripts/mod/devicetable-offsets.c:52:2
	//APP
...
.ascii "->OFF_ap_device_id_dev_type 2 offsetof(struct ap_device_id, dev_type)"
	//NO_APP
	.loc	1 55 2                          // ../scripts/mod/devicetable-offsets.c:55:2
	//APP
...
.ascii "->OFF_css_device_id_type 1 offsetof(struct css_device_id, type)"
	//NO_APP
	.loc	1 58 2                          // ../scripts/mod/devicetable-offsets.c:58:2
	//APP
...
.ascii "->OFF_serio_device_id_extra 1 offsetof(struct serio_device_id, extra)"
	//NO_APP
	.loc	1 64 2                          // ../scripts/mod/devicetable-offsets.c:64:2
	//APP
...
.ascii "->OFF_acpi_device_id_cls_msk 28 offsetof(struct acpi_device_id, cls_msk)"
	//NO_APP
	.loc	1 69 2                          // ../scripts/mod/devicetable-offsets.c:69:2
	//APP
...
.ascii "->OFF_pnp_device_id_id 0 offsetof(struct pnp_device_id, id)"
	//NO_APP
	.loc	1 72 2                          // ../scripts/mod/devicetable-offsets.c:72:2
	//APP
...
.ascii "->OFF_pnp_card_device_id_devs 16 offsetof(struct pnp_card_device_id, devs)"
	//NO_APP
	.loc	1 75 2                          // ../scripts/mod/devicetable-offsets.c:75:2
	//APP
...
.ascii "->OFF_pcmcia_device_id_prod_id_hash 12 offsetof(struct pcmcia_device_id, prod_id_hash)"
	//NO_APP
	.loc	1 84 2                          // ../scripts/mod/devicetable-offsets.c:84:2
	//APP
...
.ascii "->OFF_of_device_id_compatible 64 offsetof(struct of_device_id, compatible)"
	//NO_APP
	.loc	1 89 2                          // ../scripts/mod/devicetable-offsets.c:89:2
	//APP
...
.ascii "->OFF_vio_device_id_compat 32 offsetof(struct vio_device_id, compat)"
	//NO_APP
	.loc	1 93 2                          // ../scripts/mod/devicetable-offsets.c:93:2
	//APP
...
.ascii "->OFF_input_device_id_swbit 176 offsetof(struct input_device_id, swbit)"
	//NO_APP
	.loc	1 109 2                         // ../scripts/mod/devicetable-offsets.c:109:2
	//APP
...
.ascii "->OFF_eisa_device_id_sig 0 offsetof(struct eisa_device_id, sig)"
	//NO_APP
	.loc	1 112 2                         // ../scripts/mod/devicetable-offsets.c:112:2
	//APP
...
.ascii "->OFF_parisc_device_id_sversion 4 offsetof(struct parisc_device_id, sversion)"
	//NO_APP
	.loc	1 118 2                         // ../scripts/mod/devicetable-offsets.c:118:2
	//APP
...
.ascii "->OFF_sdio_device_id_device 4 offsetof(struct sdio_device_id, device)"
	//NO_APP
	.loc	1 123 2                         // ../scripts/mod/devicetable-offsets.c:123:2
	//APP
...
.ascii "->OFF_ssb_device_id_revision 4 offsetof(struct ssb_device_id, revision)"
	//NO_APP
	.loc	1 128 2                         // ../scripts/mod/devicetable-offsets.c:128:2
	//APP
...
.ascii "->OFF_bcma_device_id_class 5 offsetof(struct bcma_device_id, class)"
	//NO_APP
	.loc	1 134 2                         // ../scripts/mod/devicetable-offsets.c:134:2
	//APP
...
.ascii "->OFF_virtio_device_id_vendor 4 offsetof(struct virtio_device_id, vendor)"
	//NO_APP
	.loc	1 138 2                         // ../scripts/mod/devicetable-offsets.c:138:2
	//APP
...
.ascii "->OFF_hv_vmbus_device_id_guid 0 offsetof(struct hv_vmbus_device_id, guid)"
	//NO_APP
	.loc	1 141 2                         // ../scripts/mod/devicetable-offsets.c:141:2
	//APP
...
.ascii "->OFF_i2c_device_id_name 0 offsetof(struct i2c_device_id, name)"
	//NO_APP
	.loc	1 144 2                         // ../scripts/mod/devicetable-offsets.c:144:2
	//APP
...
.ascii "->OFF_spi_device_id_name 0 offsetof(struct spi_device_id, name)"
	//NO_APP
	.loc	1 147 2                         // ../scripts/mod/devicetable-offsets.c:147:2
	//APP
...
.ascii "->OFF_dmi_system_id_matches 16 offsetof(struct dmi_system_id, matches)"
	//NO_APP
	.loc	1 150 2                         // ../scripts/mod/devicetable-offsets.c:150:2
	//APP
...
.ascii "->OFF_platform_device_id_name 0 offsetof(struct platform_device_id, name)"
	//NO_APP
	.loc	1 153 2                         // ../scripts/mod/devicetable-offsets.c:153:2
	//APP
...
.ascii "->OFF_zorro_device_id_id 0 offsetof(struct zorro_device_id, id)"
	//NO_APP
	.loc	1 160 2                         // ../scripts/mod/devicetable-offsets.c:160:2
	//APP
...
.ascii "->OFF_mips_cdmm_device_id_type 0 offsetof(struct mips_cdmm_device_id, type)"
	//NO_APP
	.loc	1 176 2                         // ../scripts/mod/devicetable-offsets.c:176:2
	//APP
...
.ascii "->OFF_cpu_feature_feature 0 offsetof(struct cpu_feature, feature)"
	//NO_APP
	.loc	1 185 2                         // ../scripts/mod/devicetable-offsets.c:185:2
	//APP
...
.Linfo_string1:
	.asciz	"../scripts/mod/devicetable-offsets.c" // string offset=83
.Linfo_string2:
	.asciz	"/workspace/template-python-flask/lal/out" // string offset=120
.Linfo_string3:
